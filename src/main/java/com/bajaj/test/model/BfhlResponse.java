...
public class BfhlResponse {
    ...
    public List<String> getHighest_alphabet(){return highest_alphabet;}
    public void setHighest_alphabet(List<String> highest_alphabet){this.highest_alphabet = highest_alphabet;}
